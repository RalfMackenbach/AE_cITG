...
for i, (w_alpha, w_psi) in enumerate(zip(w_alpha_values, w_psi_values)):
    ...
    cbar.ax.set_yticklabels([f'0', f'{max_val:.3f}'])

# add title
plt.suptitle(r'$(\hat{\omega}_n, \hat{\omega}_T) = (1/3, 1)$')
...
# Save the figure
plt.savefig('plots/AE_integrand_big_eta.png', dpi=1000)
