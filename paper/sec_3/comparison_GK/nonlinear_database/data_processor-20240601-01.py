...
# load the data
file_name   = path+"/20240601-01-assembleFluxTubeMatrix_noShiftScale_nz96_withCvdrift.pkl"
file_Q      = path+"/20240601-01-103_gx_nfp4_production_gx_results_gradxRemoved.pkl"
...
if __name__ == '__main__':
    ...
    results = [pool.starmap_async(calc_AE, [(data,idx_tube,Qs[idx_tube])]) for idx_tube in range(n_tubes)]
    ...
    AEs_df.to_hdf(file_path+file_save+'-AE_data.h5', key=file_name, mode='w')