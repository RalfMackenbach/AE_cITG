...
# load the data
file_name   = path+"/20240726-01-assembleFluxTubeTensor_vacuum_nz96.pkl"
file_Q      = path+"/20240726-01-random_stellarator_equilibria_and_GX_gx_results_gradxRemoved.pkl"
